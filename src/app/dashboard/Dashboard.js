...
export class Dashboard extends Component {
  ...
  render () {
        ...
        <div className="page-header">
          <h3 className="page-title">
            <span className="page-title-icon bg-gradient-primary text-white mr-2">
              <i onClick={() => this.setState({model:true})} className="mdi mdi-home"></i>
   ...
   {this.state.responcedata.map((data) =>
      ...
      <Modal.Footer>
           <button  type="button" className="btn btn-gradient-success ">EDIT</button>
           <button  type="button" className="btn btn-gradient-danger ">DELETE</button>
    </Modal.Footer>
    </Card>
