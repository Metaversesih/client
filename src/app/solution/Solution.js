...
export class Solution extends Component {
  ...
  async componentDidMount(){
    const response = await fetch('https://metaversesih.herokuapp.com/api/getsolution');
  ...
  render () {
   ...
   {this.state.responcedata.map((data) =>
      ...
      <Card.Body>
       ...
       <p className="text-danger">{data.problemID.message} </p> 
       </blockquote>
       <Modal.Footer>
           <button  type="button" className="btn btn-gradient-success btn-fw">Add Suggestion</button>
